...
<body>
  ...
  <div class="login-container">
    ...
    <div class="login-footer">
      <p>© <?php echo date('Y'); ?> <?php echo $system_name; ?> — Powered by <a href="#">Chaturveda Software
          Solutions</a></p>
    </div>
  </div>
        ...
        <div class="ug-pane" id="pane-student">
          ...
          <div class="ug-grid">
            ...
            <div class="ug-card">
              ...
              <p>View daily class routines and securely join scheduled online live classes via external integrations.
              </p>
            </div>
            <div class="ug-card">
        ...
        <div class="ug-pane" id="pane-parent">
          ...
          <div class="ug-grid">
            <div class="ug-card">
              ...
              <p>Switch seamlessly between multiple children. Track daily attendance and academic progress in one place.
              </p>
            </div>
            <div class="ug-card">
              <div class="ug-card-icon green"><i class="fa fa-credit-card"></i></div>
              <h3>Online Fee Payment</h3>
              <p>View upcoming invoices, fee history, and securely pay tuition and other fees via integrated payment
                gateways.</p>
            </div>
            <div class="ug-card">
              <div class="ug-card-icon"><i class="fa fa-envelope-o"></i></div>
              <h3>Direct Teacher Chat</h3>
              <p>Communicate directly with class teachers for feedback and stay informed with school-wide broadcast
                messages.</p>
            </div>
          </div>
        </div>
        ...
        <div class="ug-pane" id="pane-accountant">
          ...
          <div class="ug-grid">
            <div class="ug-card">
              ...
              <p>Create fee types, generate mass invoices for classes, process offline payments, and track defaulters.
              </p>
            </div>
            <div class="ug-card">
              <div class="ug-card-icon red"><i class="fa fa-line-chart"></i></div>
              <h3>Expense Management</h3>
              <p>Record school expenses, categorize spending, and maintain a clear ledger for transparent accounting.
              </p>
            </div>
            <div class="ug-card">
              <div class="ug-card-icon purple"><i class="fa fa-file-excel-o"></i></div>
              <h3>Financial Reports</h3>
              <p>Generate precise financial statements, transaction histories, and balance sheets for management review.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="ug-pane" id="pane-admission">
          ...
          <div class="ug-grid">
            ...
            <div class="ug-card">
              ...
              <p>Approve applications, assign roll numbers, allocate hostels/transport, and officially enroll students.
              </p>
            </div>
          </div>
        </div>
