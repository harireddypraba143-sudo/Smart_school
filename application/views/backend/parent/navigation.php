...
<div class="navbar-default sidebar" role="navigation">
    ...
    <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-book p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('Academics');?><span class="fa arrow"></span></span></a>
        ...
        <li class="<?php if ($page_name == 'child_marks') echo 'active'; ?> ">
                <a href="<?php echo base_url(); ?>parents/child_marks">
                    <i class="fa fa-bar-chart p-r-10"></i>
                        <span class="hide-menu"><?php echo get_phrase('Child Report Card'); ?></span>
                </a>
        </li>
