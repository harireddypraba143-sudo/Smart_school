...
<div class="row">
    <div class="col-md-12">
        <div class="premium-card">
            <h2 class="page-title"><i class="fa fa-clipboard" style="color:#667eea;"></i> My Report Card</h2>
            <div class="breadcrumb-text">Dashboard &rsaquo; My Report Card</div>

            <div class="row">
                <div class="col-md-4">
                    <label style="font-size:12px; font-weight:600; color:#64748b;">Select Examination</label>
                    <select class="filter-select" onchange="if(this.value) location.href='<?php echo base_url(); ?>student/my_marks/' + this.value;">
