...
<?php echo form_open(base_url() . 'systemsetting/system_settings/upload_logo', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data'));
        ?>			
                ...
                <div class="panel-heading" style="background-color: transparent; border: none; padding-left: 0; color: #2ecc71;"> <i class="fa fa-qrcode"></i>&nbsp;&nbsp;<?php echo get_phrase('UPI Payment Settings'); ?></div>
                <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive" style="padding-left: 0; padding-right: 0;">

                <?php echo form_open(base_url() . 'systemsetting/system_settings/upload_upi_qr', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data'));
                        ?>			
                                    <div class="form-group"> 
                                     <label class="col-sm-12"><?php echo get_phrase('Upload UPI QR Image');?>*</label>        
                                     <div class="col-sm-12">
                                       <input type='file' class="form-control" name="userfile" onChange="readURL(this);" /required>
                                       <img src="<?php echo base_url(); ?>uploads/upi_qr.png" alt="QR Code Missing" style="max-height: 200px; margin-top: 10px; border: 1px dashed #ccc; padding: 5px;"/>
                                    </div>
                                    </div>	
                                    
                                <div class="form-group">
                                     <button class="btn btn-block btn-success btn-rounded btn-sm"><i class="fa fa-save"></i>&nbsp;<?php echo get_phrase('Update QR Code');?></button>
