    ...
    <div class="modal-dialog modal-sm" style="margin-top:80px;">
        <div class="modal-content" style="border-radius:16px; text-align:center; padding:24px;">
            ...
            <div id="qrcode_container"
                style="display:inline-block; padding:12px; background:#fff; border-radius:12px; border:2px solid #eee;">
            </div>
            ...
            <input type="text" id="scanner_url_display" class="form-control" readonly
                style="font-size:11px; text-align:center; background:#f8f9fa; margin-bottom:12px;">
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="white-box" style="border-radius: 12px; border-left: 4px solid #667eea; margin-bottom: 15px;">
            <h3 class="box-title" style="margin-bottom: 20px; font-size: 16px;"><i class="fa fa-graduation-cap"
                    style="color: #667eea;"></i> Academic Information</h3>
            <div class="row">
                <div class="form-group col-md-3">
                    <label>Admission No *</label>
                    <input type="text" class="form-control" name="admission_no" placeholder="e.g., SS/2026/0001"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-8">
                    ...
                    <div class="alert alert-info"
                        style="margin: 0; padding: 8px 12px; font-size: 12px; border-radius: 6px;">
        ...
        <div class="white-box" style="border-radius: 12px; border-left: 4px solid #16a34a; margin-bottom: 15px;">
            <h3 class="box-title" style="margin-bottom: 20px; font-size: 16px;"><i class="fa fa-user"
                    style="color: #16a34a;"></i> Personal Information</h3>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control" name="birthday" id="birthday_field"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    <label>Email *</label>
                    <input type="email" class="form-control" name="email" placeholder="e.g., student@email.com"
                        required>
                </div>
                <div class="form-group col-md-4">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    <label>Photo</label>
                    <input type='file' name="userfile" class="form-control" onChange="readURL(this);"
                        style="font-size: 12px;">
                </div>
                <div class="form-group col-md-2" style="text-align: center;">
                    <img id="preview_image" src="<?php echo base_url(); ?>uploads/student_image/default.jpg"
                        style="width: 70px; height: 70px; border-radius: 50%; border: 3px solid #eee; object-fit: cover;">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="address" class="form-control" rows="2"
                        placeholder="Full residential address (House No, Street, Village/Town, Mandal, PIN)"
                        required></textarea>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <small id="pin_status" style="color:#16a34a; display:none;"><i class="fa fa-check-circle"></i>
                        Found</small>
                </div>
                <div class="form-group col-md-3">
                    <label>State</label>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="password" class="form-control" name="password" placeholder="Student portal login"
                        required>
                </div>
            </div>
        </div>
        ...
        <div class="white-box" style="border-radius: 12px; border-left: 4px solid #f59e0b; margin-bottom: 15px;">
            <h3 class="box-title" style="margin-bottom: 20px; font-size: 16px;"><i class="fa fa-id-card"
                    style="color: #f59e0b;"></i> Identity & Compliance</h3>
        ...
        <div class="white-box" style="border-radius: 12px; border-left: 4px solid #dc2626; margin-bottom: 15px;">
            <h3 class="box-title" style="margin-bottom: 20px; font-size: 16px;"><i class="fa fa-bank"
                    style="color: #dc2626;"></i> Bank Details</h3>
            <div class="row">
                <div class="form-group col-md-4">
    ...
    <div class="col-md-6">
        ...
        <div class="white-box" style="border-radius: 12px; border-left: 4px solid #9333ea; margin-bottom: 15px;">
            <h3 class="box-title" style="margin-bottom: 15px; font-size: 16px;"><i class="fa fa-users"
                    style="color: #9333ea;"></i> Parent / Guardian Details</h3>
            ...
            <div id="existingParentSection" style="display: none;">
                <div class="form-group">
                    ...
                    <select name="parent_id" class="form-control select2" style="width:100%" id="parent_id_select"
                        disabled>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" class="form-control" name="parent_email"
                            placeholder="For parent portal login">
                    </div>
                    <div class="form-group col-md-6">
        ...
        <div class="white-box" style="border-radius: 12px; border-left: 4px solid #0891b2; margin-bottom: 15px;">
            <h3 class="box-title" style="margin-bottom: 20px; font-size: 16px;"><i class="fa fa-university"
                    style="color: #0891b2;"></i> School Assignment</h3>
        ...
        <div class="white-box" style="border-radius: 12px; border-left: 4px solid #6b7280; margin-bottom: 15px;">
            <h3 class="box-title" style="margin-bottom: 20px; font-size: 16px;"><i class="fa fa-history"
                    style="color: #6b7280;"></i> Previous School Details</h3>
...
<div class="row" style="margin-bottom: 30px;">
    <div class="col-md-12">
        <button type="submit" class="btn btn-info btn-rounded btn-block btn-lg"
            style="font-weight: 700; font-size: 16px; padding: 12px; background: linear-gradient(135deg, #667eea, #764ba2); border: none;">
                    ...
                    <tbody>
                        ...
                        foreach ($students as $student) {
                            ...
                            <tr>
                                ...
                                <td><strong
                                        style="color: #667eea;"><?php echo isset($student['admission_no']) && $student['admission_no'] ? $student['admission_no'] : '—'; ?></strong>
                                </td>
                                <td>
