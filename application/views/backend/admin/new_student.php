...
<!-- ═══════════════════════════════════════════════════════════════ -->
<!-- MODERN STYLE WRAPPER - only affects this page               -->
<!-- ═══════════════════════════════════════════════════════════════ -->
<div id="modern-admission-page">
    ...
    <style>
        ...
        #modern-admission-page {
            ...
            padding: 20px;
            margin: -15px;
            /* counter-act parent padding */
        }

        /* ── Header section ── */
        #modern-admission-page .bg-title {
        ...
        #modern-admission-page .bg-title .page-title {
            color: #fff !important;
            font-size: 22px;
        ...
        #modern-admission-page .breadcrumb {
        ...
        #modern-admission-page .breadcrumb li,
        #modern-admission-page .breadcrumb li a {
            color: rgba(255, 255, 255, 0.85);
            text-decoration: none;
        }

        #modern-admission-page .breadcrumb li.active {
            color: #fff;
            font-weight: 600;
        }

        #modern-admission-page .breadcrumb>li+li:before {
        ...
        /* ── Cards (white‑box) ── */
        #modern-admission-page .white-box {
            background: #ffffff;
            border: none;
            border-radius: 16px;
        ...
        #modern-admission-page .white-box:hover {
            box-shadow: 0 8px 30px rgba(0, 0, 0, 0.08);
        }

        #modern-admission-page .white-box .box-title {
            font-weight: 700;
            font-size: 17px;
        ...
        /* ── Accent left border for sections (keeps original color mapping) ── */
        #modern-admission-page .white-box[style*="border-left"] {
        ...
        /* ── Form elements ── */
        #modern-admission-page .form-control {
            border-radius: 10px;
        ...
        #modern-admission-page .form-control:focus {
            border-color: #4f46e5;
            box-shadow: 0 0 0 3px rgba(79, 70, 229, 0.15);
            outline: none;
        }

        #modern-admission-page select.form-control {
            background-position: right 12px center;
            padding-right: 30px;
        }

        /* ── Labels ── */
        #modern-admission-page label {
            font-weight: 600;
            font-size: 12px;
            color: #475569;
            margin-bottom: 4px;
        ...
        #modern-admission-page .btn-lg {
            padding: 12px 24px;
            font-size: 16px;
        }

        #modern-admission-page .btn-info,
        #modern-admission-page .btn-info.active {
            background: linear-gradient(135deg, #4f46e5, #7c3aed);
            border: none;
            color: #fff;
        }

        #modern-admission-page .btn-info:hover {
            background: linear-gradient(135deg, #4338ca, #6d28d9);
            transform: translateY(-1px);
            box-shadow: 0 6px 15px rgba(79, 70, 229, 0.3);
        }

        #modern-admission-page .btn-default {
            background: #f1f5f9;
            color: #334155;
            border: 1px solid #e2e8f0;
        }

        #modern-admission-page .btn-default:hover {
            background: #e2e8f0;
        }

        /* ── OCR Button specific ── */
        #modern-admission-page button[onclick="startOCRSession()"] {
        ...
        #modern-admission-page button[onclick="startOCRSession()"]:hover {
        ...
        /* ── Table ── */
        #modern-admission-page #example23_wrapper {
            border-radius: 12px;
            overflow: hidden;
        }

        #modern-admission-page table.display {
        ...
        #modern-admission-page table.display thead th {
            background: #f8fafc;
            font-weight: 700;
            color: #334155;
        ...
        #modern-admission-page table.display tbody td {
            padding: 12px;
            border-bottom: 1px solid #f1f5f9;
            vertical-align: middle;
        }

        #modern-admission-page table.display tbody tr:hover {
            background-color: #f8fafc;
        }

        /* ── Modal ── */
        #modern-admission-page #ocrModal .modal-content {
            border-radius: 20px !important;
            border: none;
            box-shadow: 0 20px 40px rgba(0, 0, 0, 0.15);
        }

        /* ── Alert boxes inside parent section ── */
        #modern-admission-page .alert {
            border-radius: 10px;
            font-size: 12px;
        }
    ...
    <div class="row bg-title">
        <div class="col-lg-5 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title" style="font-weight: 700; color: #000000 !important;">Student Admission</h4>
        </div>
    ...
    <!-- ═══════════════════════════════════════════════════════ -->
    <!-- QUICK REGISTRATION BAR (Admission No, Session, Class, Section) -->
    <!-- ═══════════════════════════════════════════════════════ -->
    <div class="white-box" style="border-radius: 16px; border-left: 5px solid #4f46e5; margin-bottom: 20px;">
        <div class="row">
            <div class="form-group col-md-3">
                <label>Admission No *</label>
                <input type="text" class="form-control" name="admission_no" placeholder="e.g., SS/2026/0001" required
            ...
            <div class="form-group col-md-3">
                ...
                <select name="class_id" class="form-control select2" style="width:100%" id="class_id"
                    onchange="$.ajax({url: '<?php echo base_url(); ?>admin/get_class_section/' + this.value, success: function(response){jQuery('#section_selector_holder').html(response);}});"
                    required>
    ...
    <!-- OCR Auto-Fill Button (now below the quick bar) -->
    <div class="row" style="margin-bottom:20px;">
        <div class="col-md-12">
            <button type="button" class="btn btn-lg" onclick="startOCRSession()"
                style="background:linear-gradient(135deg,#0f172a,#1e293b); color:#fff; font-weight:700; border:none; border-radius:12px; padding:12px 28px; box-shadow:0 4px 12px rgba(15,23,42,0.3);">
                <i class="fa fa-camera"></i> &nbsp;📸 OCR Auto Fill — Scan Aadhaar / Bank Passbook
            </button>
            <span id="ocr_connection_status" style="margin-left:15px; display:none;"></span>
        </div>
    </div>
    ...
    <div class="modal fade" id="ocrModal" tabindex="-1">
        <div class="modal-dialog modal-sm" style="margin-top:80px;">
            <div class="modal-content"
                style="border-radius:20px; text-align:center; padding:24px; border:none; box-shadow:0 20px 40px rgba(0,0,0,0.15);">
                <h4 style="font-weight:700; margin-bottom:6px;">📱 Scan with Phone</h4>
                <p style="color:#64748b; font-size:14px; margin-bottom:18px;">Open your phone camera and scan this QR
                    code</p>
                <div id="qrcode_container"
                    style="display:inline-block; padding:12px; background:#fff; border-radius:16px; border:2px solid #f1f5f9;">
                </div>
                <p style="margin-top:14px; font-size:12px; color:#94a3b8;">Or open this URL on your phone:</p>
                <input type="text" id="scanner_url_display" class="form-control" readonly
                    style="font-size:12px; text-align:center; background:#f8fafc; border-radius:10px; margin-bottom:14px;">
                <div id="ocr_waiting" style="color:#f59e0b; font-size:14px;">
                    <i class="fa fa-spinner fa-spin"></i> Waiting for scans...
                </div>
                <button class="btn btn-default btn-block" data-dismiss="modal"
                    style="margin-top:12px; border-radius:10px;">Close</button>
            </div>
        </div>
    </div>

    <!-- ═══════════════════════════════════════════════════════ -->
    <!-- STUDENT DETAILS CARD (1) -->
    <!-- ═══════════════════════════════════════════════════════ -->
    <div class="white-box" style="border-radius: 16px; border-left: 5px solid #4f46e5; margin-bottom: 20px;">
        <h3 class="box-title" style="margin-bottom: 20px; font-size: 17px;"><i class="fa fa-user"
                style="color:#4f46e5;"></i> Student Details</h3>
        <div class="row">
            <div class="form-group col-md-6">
                <label>Photo</label>
                <input type="file" name="userfile" class="form-control" accept="image/*" 
                    onchange="if(this.files && this.files[0]){ var reader = new FileReader(); reader.onload = function(e){ document.getElementById('student_preview_img').src = e.target.result; }; reader.readAsDataURL(this.files[0]); }"
                    style="font-size: 12px;">
            </div>
            <div class="form-group col-md-2" style="text-align: center;">
                <img id="student_preview_img" src="<?php echo base_url(); ?>uploads/student_image/default.jpg"
                    style="width: 75px; height: 75px; border-radius: 50%; border: 3px solid #e2e8f0; object-fit: cover; background: #fff;">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="date" class="form-control" name="birthday" id="birthday_field" onchange="calculateAge()"
                    required>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-3">
                <label>Age</label>
                <input type="text" class="form-control" name="age" id="age" readonly style="background: #f8fafc;">
            </div>
            <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" name="aadhaar_number" placeholder="e.g., 1234-5678-9012"
                    maxlength="14">
            </div>
            <div class="form-group col-md-3">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="appar_number"
                    placeholder="Automated Permanent Academic A/C">
            </div>
        </div>
    </div>

    <!-- ═══════════════════════════════════════════════════════ -->
    <!-- OTHER INFORMATION CARD (5) -->
    <!-- ═══════════════════════════════════════════════════════ -->
    <div class="white-box" style="border-radius: 16px; border-left: 5px solid #64748b; margin-bottom: 20px;">
        <h3 class="box-title" style="margin-bottom: 20px; font-size: 17px;"><i class="fa fa-map-marker"
                style="color:#64748b;"></i> Other Information</h3>
        <div class="row">
            <div class="form-group col-md-12">
                <label>Address *</label>
                <textarea name="address" class="form-control" rows="2" placeholder="Full residential address"
                    required></textarea>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-3">
                <label>PIN Code <small style="color:#94a3b8;">(auto-fills city & state)</small></label>
                <input type="text" class="form-control" name="pin_code" id="pin_code" placeholder="e.g., 500001"
                    maxlength="6" onkeyup="if(this.value.length==6) lookupPincode(this.value)">
                <small id="pin_status" style="color:#10b981; display:none;"><i class="fa fa-check-circle"></i>
                    Found</small>
            </div>
            <div class="form-group col-md-3">
                <label>State</label>
    ...
    <!-- ═══════════════════════════════════════════════════════ -->
    <!-- PARENTS / GUARDIAN DETAILS CARD (2) -->
    <!-- ═══════════════════════════════════════════════════════ -->
    <div class="white-box" style="border-radius: 16px; border-left: 5px solid #8b5cf6; margin-bottom: 20px;">
        <h3 class="box-title" style="margin-bottom: 15px; font-size: 17px;"><i class="fa fa-users"
                style="color:#8b5cf6;"></i> Parents / Guardian Details</h3>
            ...
            <div class="form-group">
                ...
                <select name="parent_id" class="form-control select2" style="width:100%" id="parent_id_select" disabled>
                    ...
                    foreach ($parents as $row) { ?>
                        <option value="<?php echo $row['parent_id']; ?>"><?php echo $row['name']; ?>
        ...
        <div id="newParentSection">
            ...
            <div style="background: #f8fafc; border-radius: 12px; padding: 18px; margin-bottom: 16px;">
                <h5 style="margin: 0 0 14px 0; font-weight: 700; color: #1e293b; font-size: 15px;">
                    <i class="fa fa-male" style="color: #3b82f6;"></i> Father's Details
                </h5>
                <div class="row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label>Father's Phone * <small style="color:#94a3b8;">(auto-detects siblings)</small></label>
                        <input type="text" class="form-control" name="father_phone" id="father_phone"
                            placeholder="e.g., 9876543210"
                            onkeyup="if(this.value.length>=10) lookupParentByPhone(this.value)">
                        <div id="sibling_alert" style="display:none; margin-top:8px;"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
            ...
            <!-- Mother Details -->
            <div style="background: #fdf2f8; border-radius: 12px; padding: 18px; margin-bottom: 16px;">
                <h5 style="margin: 0 0 14px 0; font-weight: 700; color: #1e293b; font-size: 15px;">
                    <i class="fa fa-female" style="color: #ec4899;"></i> Mother's Details
                </h5>
                <div class="row">
                    <div class="form-group col-md-6">
    ...
    <!-- ═══════════════════════════════════════════════════════ -->
    <!-- ACADEMIC INFORMATION CARD (3) - now without admission/session/class/section -->
    <!-- ═══════════════════════════════════════════════════════ -->
    <div class="white-box" style="border-radius: 16px; border-left: 5px solid #10b981; margin-bottom: 20px;">
        <h3 class="box-title" style="margin-bottom: 20px; font-size: 17px;"><i class="fa fa-graduation-cap"
                style="color:#10b981;"></i> Academic Information</h3>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-8">
                <div class="alert alert-info"
                    style="margin: 0; padding: 8px 12px; font-size: 12px; border-radius: 10px;">
                    <i class="fa fa-info-circle"></i> <strong>For old students:</strong> Set the
                    <strong>Session</strong> to their admission year, <strong>Class</strong> to their last/current
                    class, and <strong>Status</strong> accordingly.
                </div>
            </div>
        </div>

        <!-- Medium, House, Club, Category -->
        <div class="row">
            <div class="form-group col-md-3">
                <label>Medium *</label>
            ...
            <div class="form-group col-md-3">
                <label>Club *</label>
                <style>
                    /* Corrected for Select2 v3 */
                    .club-custom-dropdown + .select2-container .select2-choice {
                        background-color: #10b981 !important;
                        border-color: #10b981 !important;
                        height: 42px !important;
                        line-height: 40px !important;
                    }
                    .club-custom-dropdown + .select2-container .select2-choice .select2-chosen {
                        color: #18181b !important;
                        font-weight: 600 !important;
                        font-size: 14px !important;
                    }
                    /* Solid triangle */
                    .club-custom-dropdown + .select2-container .select2-choice .select2-arrow b {
                        border: solid #18181b !important;
                    ...
                    /* Hide default icon */
                    .club-custom-dropdown + .select2-container .select2-choice .select2-arrow b:before {
                        display: none !important;
                    }
                    
                    /* Make the dropdown LIST options black and larger globally */
        ...
        <!-- Previous School (inside Academic) -->
        <hr style="border-top: 1px solid #e2e8f0; margin: 20px 0;">
        <h4 style="font-weight: 600; font-size: 14px; margin-bottom: 15px; color: #475569;">Previous School Details</h4>
        <div class="row">
            <div class="form-group col-md-6">
    ...
    <!-- BANK DETAILS CARD (4) -->
    <!-- ═══════════════════════════════════════════════════════ -->
    <div class="white-box" style="border-radius: 16px; border-left: 5px solid #ef4444; margin-bottom: 20px;">
        <h3 class="box-title" style="margin-bottom: 20px; font-size: 17px;"><i class="fa fa-bank"
                style="color:#ef4444;"></i> Bank Details</h3>
        <div class="row">
            <div class="form-group col-md-4">
    ...
    <div class="row" style="margin-bottom: 30px;">
        <div class="col-md-12">
            <button type="submit" class="btn btn-info btn-rounded btn-block btn-lg"
                style="font-weight: 700; font-size: 16px; padding: 12px; background: linear-gradient(135deg, #4f46e5, #7c3aed); border: none; border-radius: 12px;">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box" style="border-radius: 16px;">
                            ...
                            foreach ($students as $student) {
                                ...
                                <tr>
                                    <td><img src="<?php echo $this->crud_model->get_image_url('student', $student['student_id']); ?>"
                                            class="img-circle" width="40"></td>
                                    <td><strong
                                            style="color: #4f46e5;"><?php echo isset($student['admission_no']) && $student['admission_no'] ? $student['admission_no'] : '—'; ?></strong>
                                    </td>
                                    <td>
                                        <strong><?php echo $student['name']; ?></strong><br>
                                        <small style="color: #94a3b8;"><?php echo $student['roll']; ?></small>
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-info btn-xs"
                                                onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_student/<?php echo $student['student_id']; ?>');">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="#" class="btn btn-danger btn-xs"
                                                onclick="confirm_modal('<?php echo base_url(); ?>admin/new_student/delete/<?php echo $student['student_id']; ?>');">
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status === 'has_data' && res.data) {
                    var types = ['student_aadhaar', 'father_aadhaar', 'mother_aadhaar', 'bank', 'tc', 'admission_form', 'student_photo'];
                    ...
                    document.getElementById('ocr_waiting').innerHTML =
                        '<span style="color:#16a34a;"><i class="fa fa-check-circle"></i> ' + doneCount + '/7 scans received</span>';
                }
            }
        });
    }
    ...
    function applyOCRData(type, data) {
        ...
        if (type === 'student_photo') {
            if (data.image_base64) {
                var img = document.getElementById('student_preview_img');
                if (img) {
                    img.src = data.image_base64;
                    img.style.display = 'inline-block';
                }
                
                var byteString = atob(data.image_base64.split(',')[1]);
                var mimeString = data.image_base64.split(',')[0].split(':')[1].split(';')[0];
                ...
                var file = new File([blob], "student_photo.jpg", {type: mimeString});
