                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    <!-- EDITING LINK -->
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_teacher/<?php echo $teacher['teacher_id'];?>');">                                            
                                    ...
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_hr_letter/<?php echo $teacher['teacher_id'];?>/joining');">
                                            <i class="fa fa-file-text-o text-success"></i> Joining Letter
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_hr_letter/<?php echo $teacher['teacher_id'];?>/joining_report');">
                                            <i class="fa fa-clipboard text-primary"></i> Joining Report
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_hr_letter/<?php echo $teacher['teacher_id'];?>/welcome');">
                                            <i class="fa fa-file-pdf-o text-warning"></i> Welcome Letter
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_hr_letter/<?php echo $teacher['teacher_id'];?>/hike');">
                                            <i class="fa fa-arrow-up text-primary"></i> Salary Hike Letter
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_hr_letter/<?php echo $teacher['teacher_id'];?>/relieving');">
