...
<div class="ms-a4-container">
    ...
    <div class="ms-signatures">
        ...
        <div class="ms-sig-block" style="position: relative;">
            ...
            <!-- PRINCIPAL TEXT -->
            <img src="<?php echo base_url('uploads/signature.png'); ?>?v=<?php echo time(); ?>" style="height: 35px; position: absolute; bottom: 35px; left: 50%; transform: translateX(-50%); z-index: 2; object-fit: contain; -webkit-print-color-adjust: exact !important;" onerror="this.style.display='none'">
